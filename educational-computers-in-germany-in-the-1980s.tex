...
running on the Microtronic is available {[}36{]}). And, most
...
{[}26{]} emulates the 8049 and runs the original firmware), and an
\href{https://github.com/asig/kosmos_tape_emulator}{Arduino-based CP2
cassette emulator} {[}23{]} has been developed.
...
the recursive Towers of Hanoi running on the CP1 is available {[}37{]}).
...
shown on video for the Microtronic {[}33{]}, the Kosmos CP1 {[}34{]},
and the Philips MasterLab {[}35{]}.
...
scene as \emph{LambdaMikel} and \emph{MicrotronicHamburg} {[}38{]}.
...
\emph{Figure 6. A new build running the original firmware: the
