...
oscilloscope from a homemade \textbf{R-2R DAC} on the expansion bus,
turning the INS8070\textquotesingle s speed and that bus into a small
...
On the same pipeline the author then wrote an \textbf{interactive vector
