...
\item
  ...
  first working Tic-Tac-Toe for the Microtronic, combining OLED
  graphics, spoken moves, bank-switched game state, and a genuine game
...
\emph{Figure 4. The Kosmos CP1, with its spiral-bound manual and the
...
\emph{Figure 5. Computron, the Kosmos CP1\textquotesingle s mascot, who
...
\emph{Figure 6. The Philips MasterLab and its "Microcomputer Master Lab"
manual.}
...
\emph{Figure 7. The Philips MasterLab with an attached experiment box.}
...
\emph{Figure 8. PicoRAM Ultimate (right) connected to the Philips
...
\emph{Figure 9. A new build running the original firmware: the
