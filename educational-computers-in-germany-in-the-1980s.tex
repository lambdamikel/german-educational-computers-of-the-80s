...
\emph{Figure 7. Computron, the Kosmos CP1\textquotesingle s mascot, who
...
\emph{Figure 8. The Philips MasterLab and its "Microcomputer Master Lab"
manual.}
...
\emph{Figure 9. The Philips MasterLab with an attached experiment box.}
...
\emph{Figure 10. The MasterLab\textquotesingle s vector-graphics engine
...
\emph{Figure 11. The interactive vector shooter on the real MasterLab
...
\emph{Figure 12. PicoRAM Ultimate (right) connected to the Philips
...
\emph{Figure 13. A new build running the original firmware: the
