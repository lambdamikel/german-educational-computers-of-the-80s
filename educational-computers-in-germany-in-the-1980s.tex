...
\emph{Figure 5. The Kosmos CP1, with its spiral-bound manual and the
...
\emph{Figure 6. Computron, the Kosmos CP1\textquotesingle s mascot, who
...
\emph{Figure 7. The Philips MasterLab and its "Microcomputer Master Lab"
manual.}
...
\emph{Figure 8. The Philips MasterLab with an attached experiment box.}
...
\emph{Figure 9. PicoRAM Ultimate (right) connected to the Philips
...
\emph{Figure 10. A new build running the original firmware: the
